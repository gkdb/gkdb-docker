...
# username.abs
# This must be set to either empty [] or to a list of templates users belong to.
...
# uid=Mike,ou=developers,dc=wikimedia,dc=org where Yuvipanda and Mike are
# the usernames, you would set this config item to be:
#
...
# JupyterHub uses traitlets for configuration, and the c represents the config
# object.abs
#
